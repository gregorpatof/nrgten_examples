...
if __name__ == "__main__":
	...
	prob_open, prob_closed = get_transit_probs(open_cs, closed_cs, gamma=0.001)
	...
	prob_open_mut, prob_closed_mut = get_transit_probs(open_cs_mut, closed_cs_mut, gamma=0.001)
